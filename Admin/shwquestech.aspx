<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster/admin.master" AutoEventWireup="true" CodeFile="shwquestech.aspx.cs" Inherits="Admin_shwquestech" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>" DeleteCommand="DELETE FROM [tech] WHERE [Id] = @Id" InsertCommand="INSERT INTO [tech] ([Id], [que], [op1], [op2], [op3], [op4], [ans]) VALUES (@Id, @que, @op1, @op2, @op3, @op4, @ans)" SelectCommand="SELECT [Id], [que], [op1], [op2], [op3], [op4], [ans] FROM [tech]" UpdateCommand="UPDATE [tech] SET [que] = @que, [op1] = @op1, [op2] = @op2, [op3] = @op3, [op4] = @op4, [ans] = @ans WHERE [Id] = @Id">
            <DeleteParameters>
