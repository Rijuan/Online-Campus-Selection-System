<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster/admin.master" AutoEventWireup="true" CodeFile="shwquesapti.aspx.cs" Inherits="Admin_shwquesapti" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>" DeleteCommand="DELETE FROM [apti] WHERE [Id] = @Id" InsertCommand="INSERT INTO [apti] ([Id], [que], [op1], [op2], [op3], [op4], [ans]) VALUES (@Id, @que, @op1, @op2, @op3, @op4, @ans)" SelectCommand="SELECT [Id], [que], [op1], [op2], [op3], [op4], [ans] FROM [apti]" UpdateCommand="UPDATE [apti] SET [que] = @que, [op1] = @op1, [op2] = @op2, [op3] = @op3, [op4] = @op4, [ans] = @ans WHERE [Id] = @Id">
            <DeleteParameters>
