...
public partial class Users_technitest : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            SqlDataAdapter Da = new SqlDataAdapter("select Id,que,op1,op2,op3,op4 from tech where Id>=1 and Id<=20", con);
 ...
 protected void Button1_Click1(object sender, EventArgs e)
 {
        ...
        foreach (GridViewRow r in GridView1.Rows)
        {
            ...
            Response.Write(ss);
            SqlCommand cmd1 = new SqlCommand("insert into techans values(" + l1.Text + ",'" + ss + "')", con);
            cmd1.ExecuteNonQuery();
            //calculatemarks();


        }
        Response.Redirect("techscore.aspx");
