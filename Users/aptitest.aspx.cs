...
public partial class Users_aptitest : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            SqlDataAdapter Da = new SqlDataAdapter("select Id,que,op1,op2,op3,op4 from apti where Id>=1 and Id<=10", con);
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow r in GridView1.Rows)
        {
            ...
            Response.Write(ss);
            SqlCommand cmd1 = new SqlCommand("insert into aptians values(" + l1.Text + ",'" + ss + "')", con);
            cmd1.ExecuteNonQuery();
            //calculatemarks();


        }
        Response.Redirect("aptiscore.aspx");
